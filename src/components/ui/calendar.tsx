...
function Calendar({ className, classNames, showOutsideDays = true, ...props }: CalendarProps) {
  return (
    <DayPicker
      ...
      className={cn("p-3 bg-white dark:bg-gray-900 rounded-lg pointer-events-auto", className)}
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-7 w-7 bg-white dark:bg-gray-800 p-0 opacity-70 hover:opacity-100 hover:bg-gray-100 dark:hover:bg-gray-700",
        ),
        ...
        day: cn(buttonVariants({ variant: "ghost" }), "h-9 w-9 p-0 font-normal aria-selected:opacity-100 text-foreground hover:bg-gray-100 dark:hover:bg-gray-800"),
